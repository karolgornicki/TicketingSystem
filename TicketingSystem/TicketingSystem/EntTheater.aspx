<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EntTheater.aspx.cs" Inherits="TicketingSystem.EntTheater" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GvEntTheatre" runat="server" AutoGenerateColumns="False" 
        EmptyDataText="No entartainments for this month has been scheduled." Width="100%"
        OnRowCommand="GvEntTheatre_RowCommand" CellPadding="5" 
        GridLines="None">
